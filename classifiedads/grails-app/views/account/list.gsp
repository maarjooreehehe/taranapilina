	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="create">Create New Account</g:link></li>
			</ul>
		</div>
			...
			<table>
				...
				<g:each in="${accountInstanceList}" status="i" var="accountInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="edit" id="${accountInstance.id}">${fieldValue(bean: accountInstance, field: "name")}</g:link></td>
